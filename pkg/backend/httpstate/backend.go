...
func (b *cloudBackend) ListStacks(ctx context.Context, organizationFilter *string,
	...
	apiSummaries, err := b.client.ListStacks(ctx, organizationFilter, cleanedProjectName)
	if err != nil {
		return nil, err
	}
