...
func (*GetRequiredPluginsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_language_3fcd835e2ad1e861, []int{0}
}
...
func (*GetRequiredPluginsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_language_3fcd835e2ad1e861, []int{1}
}
...
func (*RunRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_language_3fcd835e2ad1e861, []int{2}
}
...
func (*RunResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_language_3fcd835e2ad1e861, []int{3}
}
...
// PrepareProjectResponse is the response back from running PrepareProjectResponse.
...
func (m *PrepareProjectResponse) Reset()         { *m = PrepareProjectResponse{} }
func (m *PrepareProjectResponse) String() string { return proto.CompactTextString(m) }
func (*PrepareProjectResponse) ProtoMessage()    {}
func (*PrepareProjectResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_language_3fcd835e2ad1e861, []int{4}
}
func (m *PrepareProjectResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_PrepareProjectResponse.Unmarshal(m, b)
}
func (m *PrepareProjectResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_PrepareProjectResponse.Marshal(b, m, deterministic)
}
func (dst *PrepareProjectResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrepareProjectResponse.Merge(dst, src)
}
func (m *PrepareProjectResponse) XXX_Size() int {
	return xxx_messageInfo_PrepareProjectResponse.Size(m)
}
func (m *PrepareProjectResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_PrepareProjectResponse.DiscardUnknown(m)
}

var xxx_messageInfo_PrepareProjectResponse proto.InternalMessageInfo

func (m *PrepareProjectResponse) GetError() string {
	if m != nil {
		return m.Error
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*PrepareProjectResponse)(nil), "pulumirpc.PrepareProjectResponse")
}
...
type LanguageRuntimeClient interface {
	...
	PrepareProject(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PrepareProjectResponse, error)
...
func (c *languageRuntimeClient) PrepareProject(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PrepareProjectResponse, error) {
	out := new(PrepareProjectResponse)
	err := grpc.Invoke(ctx, "/pulumirpc.LanguageRuntime/PrepareProject", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LanguageRuntimeServer interface {
	...
	// PrepareProject runs command necessary to prepare the project before it is run, such as `npm install`.
	PrepareProject(context.Context, *empty.Empty) (*PrepareProjectResponse, error)
	// Run executes a program and returns its result.
...
func _LanguageRuntime_PrepareProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(empty.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LanguageRuntimeServer).PrepareProject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pulumirpc.LanguageRuntime/PrepareProject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LanguageRuntimeServer).PrepareProject(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _LanguageRuntime_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PrepareProject",
			Handler:    _LanguageRuntime_PrepareProject_Handler,
		},
		{
			MethodName: "Run",
...
func init() { proto.RegisterFile("language.proto", fileDescriptor_language_3fcd835e2ad1e861) }

var fileDescriptor_language_3fcd835e2ad1e861 = []byte{
	// 480 bytes of a gzipped FileDescriptorProto
	,
}
