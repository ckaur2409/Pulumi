...
func (*ReadResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_bc30b7f834d8b4e1, []int{0}
}
...
func (*ReadResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_bc30b7f834d8b4e1, []int{1}
}
...
func (*RegisterResourceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_bc30b7f834d8b4e1, []int{2}
}
...
func (*RegisterResourceResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_bc30b7f834d8b4e1, []int{3}
}
...
func (*RegisterResourceOutputsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_resource_bc30b7f834d8b4e1, []int{4}
}
...
func init() { proto.RegisterFile("resource.proto", fileDescriptor_resource_bc30b7f834d8b4e1) }

var fileDescriptor_resource_bc30b7f834d8b4e1 = []byte{
