...
func (LogSeverity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_engine_d2aaa01b1d6e8dd6, []int{0}
}
...
func init() { proto.RegisterFile("engine.proto", fileDescriptor_engine_d2aaa01b1d6e8dd6) }

var fileDescriptor_engine_d2aaa01b1d6e8dd6 = []byte{
